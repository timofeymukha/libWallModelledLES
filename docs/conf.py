...
htmlhelp_basename = 'libWallModelledLESdoc'
...
latex_documents = [
    (master_doc, 'libWallModelledLES.tex', 'libWallModelledLES Documentation',
...
man_pages = [
    (master_doc, 'libwallmodelledles', 'libWallModelledLES Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'libWallModelledLES', 'libWallModelledLES Documentation',
     author, 'libWallModelledLES', 'One line description of project.',
     'Miscellaneous'),
]
