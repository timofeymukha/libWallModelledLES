...
Wall stress modelling fits naturally into the numerical framework of OpenFOAM, i.e. finite volume discretization.
...
numerical integration using the trapezoidal rule, and does not solve an ODE directly.
